...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('hunt-lantern-blow', 'assets/game/players/hunt-lantern/blow.png', LANT)
    this.load.spritesheet('hunt-lantern-relight', 'assets/game/players/hunt-lantern/relight.png', LANT)
    ...
    this.load.image('ui-stone-danger', 'assets/game/ui/ui-stone-danger.png')
